...
%**************************************************************
\frontmatter
\input{intro-ending/frontispiece}
% \input{intro-ending/sommario}
\input{intro-ending/index}
\cleardoublepage
...
\input{chapters/chapter-2}             % Handshake
\input{chapters/chapter-3}             % Messages
\input{chapters/chapter-4}             % User manual
...
% \input{inizio-fine/bibliography}
\end{document}
